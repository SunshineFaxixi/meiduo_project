# -*- coding: utf-8 -*-
# Generated by Django 1.11.11 on 2020-10-04 23:48
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('spu', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='spu', to='goods.SPU', verbose_name='商品SPU')),
            ],
            options={
        ...
        migrations.AddField(
            ...
            name='option',
            field=models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, related_name='specopt', to='goods.SpecificationOption', verbose_name='规格值'),
        ),
        migrations.AddField(
            model_name='skuspecification',
            name='sku',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='skus', to='goods.SPU', verbose_name='sku'),
        ),
        migrations.AddField(
            model_name='skuspecification',
            name='spec',
            field=models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, related_name='spuspec', to='goods.SPUSpecification', verbose_name='规格名称'),
        ),
        migrations.AddField(
            model_name='sku',
            name='spu',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='sku', to='goods.SPU', verbose_name='商品'),
        ),
        migrations.AddField(
            model_name='goodchannel',
            name='category',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='goods.GoodsCategory', verbose_name='顶级商品类别'),
        ),
        migrations.AddField(
            model_name='goodchannel',
            name='group',
