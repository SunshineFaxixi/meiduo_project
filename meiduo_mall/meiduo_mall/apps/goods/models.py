...
class Brand(BaseModel):
    ...
    first_level = models.CharField(max_length=1, verbose_name='品牌首字母')
...
class SKU(BaseModel):
    ...
    spu = models.ForeignKey(SPU, on_delete=models.CASCADE, related_name='sku', verbose_name='商品')
...
class SPUSpecification(BaseModel):
    """商品SPU规格"""
    spu = models.ForeignKey(SPU, on_delete=models.CASCADE, related_name='spu', verbose_name='商品SPU')
...
class SpecificationOption(BaseModel):
    ...
    def __str__(self):
        return '%s - %s' % (self.spe.name, self.value)


class SKUSpecification(BaseModel):
    """SKU具体规格"""
    sku = models.ForeignKey(SPU, related_name='skus', on_delete=models.CASCADE, verbose_name='sku')
    spec = models.ForeignKey(SPUSpecification, related_name='spuspec', on_delete=models.PROTECT, verbose_name='规格名称')
    option = models.ForeignKey(SpecificationOption, related_name='specopt', on_delete=models.PROTECT, verbose_name='规格值')
